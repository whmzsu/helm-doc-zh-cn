...
本指南是官方Kubernetes的github库下，helm子目录下的文档的翻译，依照 https://docs.helm.sh/ 的文档架构和组织，当前翻译了第一部分的用户指南部分，后续会陆续更新，用于给刚接触Helm这个工具的朋友一个指导手册。由于Gitbook不支持花括弧，所以临时处理了一下，会持续更新（如果有朋友知道如何更好的在gitbook里面处理花括弧，欢迎告知我）！！
